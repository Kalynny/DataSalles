...
import br.com.datasalles.domain.PesquisaPCompra;
import br.com.datasalles.util.HibernateUtil;

public class PesquisaPCompraDAO  extends GenericDAO<PesquisaPCompra>{
	...
	public List listarPorData(Date dataInicio, Date dataFim){
		Session sessao = HibernateUtil.getFabricaDeSessoes().openSession();		
				try{
					...
					Criteria consulta = sessao.createCriteria(PesquisaPCompra.class);
